      ...
      <div className="createaspotContainer">
        <form className="createaspotForm">
          ...
          <div className="descriptionContainer">
            ...
            <h4>
              Mention the best features of your space, any special amentities like fast wifi or parking, and what you
              love about the neighborhood.
            </h4>
            <textarea className="descriptionTextarea" placeholder="Please write at least 30 characters"></textarea>
          </div>
